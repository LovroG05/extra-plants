...
public class BlockQuartzSpikes extends ElementsExtraPlantsMod.ModElement {
	@GameRegistry.ObjectHolder("extra_plants:quartz_spikes")
	public static final Block block = null;
	public BlockQuartzSpikes(ElementsExtraPlantsMod instance) {
		super(instance, 10);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("extra_plants:quartz_spikes", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("quartz_spikes");
			setRegistryName("quartz_spikes");
		}
