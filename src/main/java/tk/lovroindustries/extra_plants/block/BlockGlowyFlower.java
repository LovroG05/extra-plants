...
package tk.lovroindustries.extra_plants.block;

import tk.lovroindustries.extra_plants.procedure.ProcedureGlowyFlowerPlantBonemealed;
...
public class BlockGlowyFlower extends ElementsExtraPlantsMod.ModElement {
	@GameRegistry.ObjectHolder("extra_plants:glowy_flower")
	public static final Block block = null;
	public BlockGlowyFlower(ElementsExtraPlantsMod instance) {
		super(instance, 1);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("extra_plants:glowy_flower", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0.5F);
			setUnlocalizedName("glowy_flower");
			setRegistryName("glowy_flower");
		}
		...
		public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing direction,
			...
			int z = pos.getZ();
			{
				...
				ProcedureGlowyFlowerPlantBonemealed.executeProcedure($_dependencies);
			}
			return true;
		}
	}
