...
public class BlockCottonBush extends ElementsExtraPlantsMod.ModElement {
	@GameRegistry.ObjectHolder("extra_plants:cotton_bush")
	public static final Block block = null;
	public BlockCottonBush(ElementsExtraPlantsMod instance) {
		super(instance, 5);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("extra_plants:cotton_bush", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("cotton_bush");
			setRegistryName("cotton_bush");
		}
